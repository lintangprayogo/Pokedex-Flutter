...
class _$AbilityImpl implements _Ability {
  const _$AbilityImpl({required this.url, required this.name});
  ...
  @override
  String toString() {
    return 'Ability(url: $url, name: $name)';
  }
...
abstract class _Ability implements Ability {
  const factory _Ability(
      {required final String url, required final String name}) = _$AbilityImpl;
