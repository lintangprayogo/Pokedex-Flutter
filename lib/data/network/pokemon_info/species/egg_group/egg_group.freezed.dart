...
class _$EggGroupImpl implements _EggGroup {
  const _$EggGroupImpl({required this.name, required this.url});
  ...
  @override
  String toString() {
    return 'EggGroup(name: $name, url: $url)';
  }
...
abstract class _EggGroup implements EggGroup {
  const factory _EggGroup(
      {required final String name, required final String url}) = _$EggGroupImpl;
