...
class _$MoveImpl implements _Move {
  const _$MoveImpl({required this.url, required this.name});
...
abstract class _Move implements Move {
  const factory _Move({required final String url, required final String name}) =
      _$MoveImpl;
